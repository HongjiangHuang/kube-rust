...
pub trait AuthenticationV1beta1Api {
    fn create_token_review(&self, body: crate::models::V1beta1TokenReview, dry_run: Option<&str>, field_manager: Option<&str>, pretty: Option<&str>) -> Box<dyn Future<Item = crate::models::V1beta1TokenReview, Error = Error<serde_json::Value>>>;
...
impl<C: hyper::client::Connect>AuthenticationV1beta1Api for AuthenticationV1beta1ApiClient<C> {
    fn create_token_review(&self, body: crate::models::V1beta1TokenReview, dry_run: Option<&str>, field_manager: Option<&str>, pretty: Option<&str>) -> Box<dyn Future<Item = crate::models::V1beta1TokenReview, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Post, "/apis/authentication.k8s.io/v1beta1/tokenreviews".to_string())
    ...
    fn get_api_resources(&self, ) -> Box<dyn Future<Item = crate::models::V1ApiResourceList, Error = Error<serde_json::Value>>> {
        let mut req = __internal_request::Request::new(hyper::Method::Get, "/apis/authentication.k8s.io/v1beta1/".to_string())
            .with_auth(__internal_request::Auth::ApiKey(__internal_request::ApiKey{
                in_header: true,
                in_query: false,
                param_name: "authorization".to_owned(),
