...
pub async fn create_token_review(configuration: &configuration::Configuration, body: crate::models::V1TokenReview, dry_run: Option<&str>, field_manager: Option<&str>, pretty: Option<&str>) -> Result<crate::models::V1TokenReview, Error<CreateTokenReviewError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/apis/authentication.k8s.io/v1/tokenreviews", configuration.base_path);
...
pub async fn get_api_resources(configuration: &configuration::Configuration, ) -> Result<crate::models::V1ApiResourceList, Error<GetApiResourcesError>> {
    ...
    let local_var_uri_str = format!("{}/apis/authentication.k8s.io/v1/", configuration.base_path);
