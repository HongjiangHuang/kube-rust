...
pub struct V1beta1SelfSubjectAccessReview {
    ...
    #[serde(rename = "spec")]
    pub spec: Box<crate::models::V1beta1SelfSubjectAccessReviewSpec>,
...
impl V1beta1SelfSubjectAccessReview {
    ...
    pub fn new(spec: crate::models::V1beta1SelfSubjectAccessReviewSpec) -> V1beta1SelfSubjectAccessReview {
