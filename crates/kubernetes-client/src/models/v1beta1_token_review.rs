...
pub struct V1beta1TokenReview {
    ...
    #[serde(rename = "spec")]
    pub spec: Box<crate::models::V1beta1TokenReviewSpec>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Box<crate::models::V1beta1TokenReviewStatus>>,
}

impl V1beta1TokenReview {
    /// TokenReview attempts to authenticate a token to a known user. Note: TokenReview requests may be cached by the webhook token authenticator plugin in the kube-apiserver.
    pub fn new(spec: crate::models::V1beta1TokenReviewSpec) -> V1beta1TokenReview {
        V1beta1TokenReview {
            api_version: None,
            kind: None,
            metadata: None,
