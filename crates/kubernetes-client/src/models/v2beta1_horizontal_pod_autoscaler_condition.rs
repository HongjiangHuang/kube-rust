...
pub struct V2beta1HorizontalPodAutoscalerCondition {
...
impl V2beta1HorizontalPodAutoscalerCondition {
    /// HorizontalPodAutoscalerCondition describes the state of a HorizontalPodAutoscaler at a certain point.
    pub fn new(status: String, _type: String) -> V2beta1HorizontalPodAutoscalerCondition {
