...
pub struct V1beta1VolumeAttachment {
    ...
    #[serde(rename = "spec")]
    pub spec: Box<crate::models::V1beta1VolumeAttachmentSpec>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Box<crate::models::V1beta1VolumeAttachmentStatus>>,
}

impl V1beta1VolumeAttachment {
    /// VolumeAttachment captures the intent to attach or detach the specified volume to/from the specified node.  VolumeAttachment objects are non-namespaced.
    pub fn new(spec: crate::models::V1beta1VolumeAttachmentSpec) -> V1beta1VolumeAttachment {
