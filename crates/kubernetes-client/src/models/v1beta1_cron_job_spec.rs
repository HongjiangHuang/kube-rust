...
pub struct V1beta1CronJobSpec {
    ...
    pub job_template: Box<crate::models::V1beta1JobTemplateSpec>,
...
impl V1beta1CronJobSpec {
    /// CronJobSpec describes how the job execution will look like and when it will actually run.
    pub fn new(job_template: crate::models::V1beta1JobTemplateSpec, schedule: String) -> V1beta1CronJobSpec {
        V1beta1CronJobSpec {
