...
pub struct V1beta1MutatingWebhook {
...
impl V1beta1MutatingWebhook {
    /// MutatingWebhook describes an admission webhook and the resources and operations it applies to.
    pub fn new(client_config: crate::models::AdmissionregistrationV1beta1WebhookClientConfig, name: String) -> V1beta1MutatingWebhook {
