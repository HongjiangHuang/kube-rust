...
> crate::models::V2beta2HorizontalPodAutoscaler create_namespaced_horizontal_pod_autoscaler(namespace, body, pretty, dry_run, field_manager)
...
**body** | [**V2beta2HorizontalPodAutoscaler**](V2beta2HorizontalPodAutoscaler.md) |  | [required] |
...
[**crate::models::V2beta2HorizontalPodAutoscaler**](v2beta2.HorizontalPodAutoscaler.md)
...
> crate::models::V1Status delete_collection_namespaced_horizontal_pod_autoscaler(namespace, pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, timeout_seconds, body)
...
> crate::models::V2beta2HorizontalPodAutoscalerList list_horizontal_pod_autoscaler_for_all_namespaces(allow_watch_bookmarks, _continue, field_selector, label_selector, limit, pretty, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V2beta2HorizontalPodAutoscalerList**](v2beta2.HorizontalPodAutoscalerList.md)
...
> crate::models::V2beta2HorizontalPodAutoscalerList list_namespaced_horizontal_pod_autoscaler(namespace, pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V2beta2HorizontalPodAutoscaler patch_namespaced_horizontal_pod_autoscaler(name, namespace, body, pretty, dry_run, field_manager, force)
...
> crate::models::V2beta2HorizontalPodAutoscaler patch_namespaced_horizontal_pod_autoscaler_status(name, namespace, body, pretty, dry_run, field_manager, force)
...
> crate::models::V2beta2HorizontalPodAutoscaler read_namespaced_horizontal_pod_autoscaler(name, namespace, pretty)
...
> crate::models::V2beta2HorizontalPodAutoscaler read_namespaced_horizontal_pod_autoscaler_status(name, namespace, pretty)
...
> crate::models::V2beta2HorizontalPodAutoscaler replace_namespaced_horizontal_pod_autoscaler(name, namespace, body, pretty, dry_run, field_manager)
...
> crate::models::V2beta2HorizontalPodAutoscaler replace_namespaced_horizontal_pod_autoscaler_status(name, namespace, body, pretty, dry_run, field_manager)
