...
> crate::models::V1beta1FlowSchema create_flow_schema(body, pretty, dry_run, field_manager)
...
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1beta1FlowSchema**](V1beta1FlowSchema.md) |  | [required] |
...
[**crate::models::V1beta1FlowSchema**](v1beta1.FlowSchema.md)
...
> crate::models::V1beta1PriorityLevelConfiguration create_priority_level_configuration(body, pretty, dry_run, field_manager)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1beta1PriorityLevelConfiguration**](V1beta1PriorityLevelConfiguration.md) |  | [required] |
**pretty** | Option<**String**> | If 'true', then the output is pretty printed. |  |
**dry_run** | Option<**String**> | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed |  |
**field_manager** | Option<**String**> | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. |  |
...
[**crate::models::V1beta1PriorityLevelConfiguration**](v1beta1.PriorityLevelConfiguration.md)
...
> crate::models::V1Status delete_collection_flow_schema(pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, timeout_seconds, body)
...
> crate::models::V1Status delete_collection_priority_level_configuration(pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, timeout_seconds, body)
...
> crate::models::V1beta1FlowSchemaList list_flow_schema(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1beta1FlowSchemaList**](v1beta1.FlowSchemaList.md)
...
> crate::models::V1beta1PriorityLevelConfigurationList list_priority_level_configuration(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1beta1PriorityLevelConfigurationList**](v1beta1.PriorityLevelConfigurationList.md)
...
> crate::models::V1beta1FlowSchema patch_flow_schema(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1beta1FlowSchema patch_flow_schema_status(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1beta1PriorityLevelConfiguration patch_priority_level_configuration(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1beta1PriorityLevelConfiguration patch_priority_level_configuration_status(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1beta1FlowSchema read_flow_schema(name, pretty)
...
> crate::models::V1beta1FlowSchema read_flow_schema_status(name, pretty)
...
> crate::models::V1beta1PriorityLevelConfiguration read_priority_level_configuration(name, pretty)
...
> crate::models::V1beta1PriorityLevelConfiguration read_priority_level_configuration_status(name, pretty)
...
> crate::models::V1beta1FlowSchema replace_flow_schema(name, body, pretty, dry_run, field_manager)
...
> crate::models::V1beta1FlowSchema replace_flow_schema_status(name, body, pretty, dry_run, field_manager)
...
> crate::models::V1beta1PriorityLevelConfiguration replace_priority_level_configuration(name, body, pretty, dry_run, field_manager)
...
> crate::models::V1beta1PriorityLevelConfiguration replace_priority_level_configuration_status(name, body, pretty, dry_run, field_manager)
