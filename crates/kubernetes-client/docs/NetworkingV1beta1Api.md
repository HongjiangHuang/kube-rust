...
> crate::models::V1beta1IngressClass create_ingress_class(body, pretty, dry_run, field_manager)
...
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1beta1IngressClass**](V1beta1IngressClass.md) |  | [required] |
...
[**crate::models::V1beta1IngressClass**](v1beta1.IngressClass.md)
...
> crate::models::NetworkingV1beta1Ingress create_namespaced_ingress(namespace, body, pretty, dry_run, field_manager)
...
**body** | [**NetworkingV1beta1Ingress**](NetworkingV1beta1Ingress.md) |  | [required] |
**pretty** | Option<**String**> | If 'true', then the output is pretty printed. |  |
**dry_run** | Option<**String**> | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed |  |
**field_manager** | Option<**String**> | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. |  |
...
[**crate::models::NetworkingV1beta1Ingress**](networking.v1beta1.Ingress.md)
...
> crate::models::V1beta1IngressClassList list_ingress_class(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1beta1IngressClassList**](v1beta1.IngressClassList.md)
...
> crate::models::NetworkingV1beta1IngressList list_ingress_for_all_namespaces(allow_watch_bookmarks, _continue, field_selector, label_selector, limit, pretty, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::NetworkingV1beta1IngressList**](networking.v1beta1.IngressList.md)
...
> crate::models::NetworkingV1beta1IngressList list_namespaced_ingress(namespace, pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1beta1IngressClass patch_ingress_class(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::NetworkingV1beta1Ingress patch_namespaced_ingress(name, namespace, body, pretty, dry_run, field_manager, force)
...
> crate::models::NetworkingV1beta1Ingress patch_namespaced_ingress_status(name, namespace, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1beta1IngressClass read_ingress_class(name, pretty)
...
> crate::models::NetworkingV1beta1Ingress read_namespaced_ingress(name, namespace, pretty)
...
> crate::models::NetworkingV1beta1Ingress read_namespaced_ingress_status(name, namespace, pretty)
...
> crate::models::V1beta1IngressClass replace_ingress_class(name, body, pretty, dry_run, field_manager)
...
> crate::models::NetworkingV1beta1Ingress replace_namespaced_ingress(name, namespace, body, pretty, dry_run, field_manager)
...
> crate::models::NetworkingV1beta1Ingress replace_namespaced_ingress_status(name, namespace, body, pretty, dry_run, field_manager)
