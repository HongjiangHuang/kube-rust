...
> crate::models::V1alpha1PriorityClass create_priority_class(body, pretty, dry_run, field_manager)
...
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1alpha1PriorityClass**](V1alpha1PriorityClass.md) |  | [required] |
...
[**crate::models::V1alpha1PriorityClass**](v1alpha1.PriorityClass.md)
...
> crate::models::V1Status delete_collection_priority_class(pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, timeout_seconds, body)
...
> crate::models::V1alpha1PriorityClassList list_priority_class(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1alpha1PriorityClassList**](v1alpha1.PriorityClassList.md)
...
> crate::models::V1alpha1PriorityClass patch_priority_class(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1alpha1PriorityClass read_priority_class(name, pretty)
...
> crate::models::V1alpha1PriorityClass replace_priority_class(name, body, pretty, dry_run, field_manager)
