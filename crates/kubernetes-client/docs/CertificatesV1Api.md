...
> crate::models::V1CertificateSigningRequest create_certificate_signing_request(body, pretty, dry_run, field_manager)
...
> crate::models::V1CertificateSigningRequestList list_certificate_signing_request(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1CertificateSigningRequest patch_certificate_signing_request(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1CertificateSigningRequest patch_certificate_signing_request_approval(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1CertificateSigningRequest patch_certificate_signing_request_status(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1CertificateSigningRequest replace_certificate_signing_request(name, body, pretty, dry_run, field_manager)
...
> crate::models::V1CertificateSigningRequest replace_certificate_signing_request_approval(name, body, pretty, dry_run, field_manager)
...
> crate::models::V1CertificateSigningRequest replace_certificate_signing_request_status(name, body, pretty, dry_run, field_manager)
