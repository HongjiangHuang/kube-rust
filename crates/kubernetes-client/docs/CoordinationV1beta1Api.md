...
> crate::models::V1beta1Lease create_namespaced_lease(namespace, body, pretty, dry_run, field_manager)
...
**body** | [**V1beta1Lease**](V1beta1Lease.md) |  | [required] |
...
[**crate::models::V1beta1Lease**](v1beta1.Lease.md)
...
> crate::models::V1Status delete_collection_namespaced_lease(namespace, pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, timeout_seconds, body)
...
> crate::models::V1beta1LeaseList list_lease_for_all_namespaces(allow_watch_bookmarks, _continue, field_selector, label_selector, limit, pretty, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1beta1LeaseList**](v1beta1.LeaseList.md)
...
> crate::models::V1beta1LeaseList list_namespaced_lease(namespace, pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1beta1Lease patch_namespaced_lease(name, namespace, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1beta1Lease read_namespaced_lease(name, namespace, pretty)
...
> crate::models::V1beta1Lease replace_namespaced_lease(name, namespace, body, pretty, dry_run, field_manager)
