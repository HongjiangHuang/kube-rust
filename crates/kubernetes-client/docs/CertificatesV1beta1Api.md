...
> crate::models::V1beta1CertificateSigningRequest create_certificate_signing_request(body, pretty, dry_run, field_manager)
...
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1beta1CertificateSigningRequest**](V1beta1CertificateSigningRequest.md) |  | [required] |
...
[**crate::models::V1beta1CertificateSigningRequest**](v1beta1.CertificateSigningRequest.md)
...
> crate::models::V1Status delete_collection_certificate_signing_request(pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, timeout_seconds, body)
...
> crate::models::V1beta1CertificateSigningRequestList list_certificate_signing_request(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1beta1CertificateSigningRequestList**](v1beta1.CertificateSigningRequestList.md)
...
> crate::models::V1beta1CertificateSigningRequest patch_certificate_signing_request(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1beta1CertificateSigningRequest patch_certificate_signing_request_approval(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1beta1CertificateSigningRequest patch_certificate_signing_request_status(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1beta1CertificateSigningRequest read_certificate_signing_request(name, pretty)
...
> crate::models::V1beta1CertificateSigningRequest read_certificate_signing_request_approval(name, pretty)
...
> crate::models::V1beta1CertificateSigningRequest read_certificate_signing_request_status(name, pretty)
...
> crate::models::V1beta1CertificateSigningRequest replace_certificate_signing_request(name, body, pretty, dry_run, field_manager)
...
> crate::models::V1beta1CertificateSigningRequest replace_certificate_signing_request_approval(name, body, pretty, dry_run, field_manager)
...
> crate::models::V1beta1CertificateSigningRequest replace_certificate_signing_request_status(name, body, pretty, dry_run, field_manager)
