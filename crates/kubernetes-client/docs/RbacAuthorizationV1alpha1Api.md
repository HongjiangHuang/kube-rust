...
> crate::models::V1alpha1ClusterRole create_cluster_role(body, pretty, dry_run, field_manager)
...
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1alpha1ClusterRole**](V1alpha1ClusterRole.md) |  | [required] |
...
[**crate::models::V1alpha1ClusterRole**](v1alpha1.ClusterRole.md)
...
> crate::models::V1alpha1ClusterRoleBinding create_cluster_role_binding(body, pretty, dry_run, field_manager)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1alpha1ClusterRoleBinding**](V1alpha1ClusterRoleBinding.md) |  | [required] |
**pretty** | Option<**String**> | If 'true', then the output is pretty printed. |  |
**dry_run** | Option<**String**> | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed |  |
**field_manager** | Option<**String**> | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. |  |
...
[**crate::models::V1alpha1ClusterRoleBinding**](v1alpha1.ClusterRoleBinding.md)
...
> crate::models::V1alpha1Role create_namespaced_role(namespace, body, pretty, dry_run, field_manager)
...
**body** | [**V1alpha1Role**](V1alpha1Role.md) |  | [required] |
**pretty** | Option<**String**> | If 'true', then the output is pretty printed. |  |
**dry_run** | Option<**String**> | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed |  |
**field_manager** | Option<**String**> | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. |  |
...
[**crate::models::V1alpha1Role**](v1alpha1.Role.md)
...
> crate::models::V1alpha1RoleBinding create_namespaced_role_binding(namespace, body, pretty, dry_run, field_manager)
...
------------- | ------------- | ------------- | ------------- | -------------
**namespace** | **String** | object name and auth scope, such as for teams and projects | [required] |
**body** | [**V1alpha1RoleBinding**](V1alpha1RoleBinding.md) |  | [required] |
**pretty** | Option<**String**> | If 'true', then the output is pretty printed. |  |
**dry_run** | Option<**String**> | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed |  |
**field_manager** | Option<**String**> | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. |  |
...
[**crate::models::V1alpha1RoleBinding**](v1alpha1.RoleBinding.md)
...
> crate::models::V1Status delete_collection_cluster_role(pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, timeout_seconds, body)
...
> crate::models::V1Status delete_collection_cluster_role_binding(pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, timeout_seconds, body)
...
> crate::models::V1Status delete_collection_namespaced_role(namespace, pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, timeout_seconds, body)
...
> crate::models::V1Status delete_collection_namespaced_role_binding(namespace, pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, timeout_seconds, body)
...
> crate::models::V1alpha1ClusterRoleList list_cluster_role(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1alpha1ClusterRoleList**](v1alpha1.ClusterRoleList.md)
...
> crate::models::V1alpha1ClusterRoleBindingList list_cluster_role_binding(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1alpha1ClusterRoleBindingList**](v1alpha1.ClusterRoleBindingList.md)
...
> crate::models::V1alpha1RoleList list_namespaced_role(namespace, pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1alpha1RoleList**](v1alpha1.RoleList.md)
...
> crate::models::V1alpha1RoleBindingList list_namespaced_role_binding(namespace, pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1alpha1RoleBindingList**](v1alpha1.RoleBindingList.md)
...
> crate::models::V1alpha1RoleBindingList list_role_binding_for_all_namespaces(allow_watch_bookmarks, _continue, field_selector, label_selector, limit, pretty, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1alpha1RoleList list_role_for_all_namespaces(allow_watch_bookmarks, _continue, field_selector, label_selector, limit, pretty, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1alpha1ClusterRole patch_cluster_role(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1alpha1ClusterRoleBinding patch_cluster_role_binding(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1alpha1Role patch_namespaced_role(name, namespace, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1alpha1RoleBinding patch_namespaced_role_binding(name, namespace, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1alpha1ClusterRole read_cluster_role(name, pretty)
...
> crate::models::V1alpha1ClusterRoleBinding read_cluster_role_binding(name, pretty)
...
> crate::models::V1alpha1Role read_namespaced_role(name, namespace, pretty)
...
> crate::models::V1alpha1RoleBinding read_namespaced_role_binding(name, namespace, pretty)
...
> crate::models::V1alpha1ClusterRole replace_cluster_role(name, body, pretty, dry_run, field_manager)
...
> crate::models::V1alpha1ClusterRoleBinding replace_cluster_role_binding(name, body, pretty, dry_run, field_manager)
...
> crate::models::V1alpha1Role replace_namespaced_role(name, namespace, body, pretty, dry_run, field_manager)
...
> crate::models::V1alpha1RoleBinding replace_namespaced_role_binding(name, namespace, body, pretty, dry_run, field_manager)
