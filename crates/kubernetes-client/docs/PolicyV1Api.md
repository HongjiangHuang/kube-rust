...
> crate::models::V1PodDisruptionBudget create_namespaced_pod_disruption_budget(namespace, body, pretty, dry_run, field_manager)
...
> crate::models::V1PodDisruptionBudgetList list_namespaced_pod_disruption_budget(namespace, pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1PodDisruptionBudgetList list_pod_disruption_budget_for_all_namespaces(allow_watch_bookmarks, _continue, field_selector, label_selector, limit, pretty, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1PodDisruptionBudget patch_namespaced_pod_disruption_budget(name, namespace, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1PodDisruptionBudget patch_namespaced_pod_disruption_budget_status(name, namespace, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1PodDisruptionBudget replace_namespaced_pod_disruption_budget(name, namespace, body, pretty, dry_run, field_manager)
...
> crate::models::V1PodDisruptionBudget replace_namespaced_pod_disruption_budget_status(name, namespace, body, pretty, dry_run, field_manager)
