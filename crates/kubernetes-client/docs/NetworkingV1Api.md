...
> crate::models::V1IngressClass create_ingress_class(body, pretty, dry_run, field_manager)
...
> crate::models::V1Ingress create_namespaced_ingress(namespace, body, pretty, dry_run, field_manager)
...
> crate::models::V1NetworkPolicy create_namespaced_network_policy(namespace, body, pretty, dry_run, field_manager)
...
> crate::models::V1Status delete_collection_ingress_class(pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, timeout_seconds, body)
...
> crate::models::V1Status delete_collection_namespaced_network_policy(namespace, pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, timeout_seconds, body)
...
> crate::models::V1IngressClassList list_ingress_class(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1IngressList list_ingress_for_all_namespaces(allow_watch_bookmarks, _continue, field_selector, label_selector, limit, pretty, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1IngressList list_namespaced_ingress(namespace, pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1NetworkPolicyList list_namespaced_network_policy(namespace, pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1NetworkPolicyList list_network_policy_for_all_namespaces(allow_watch_bookmarks, _continue, field_selector, label_selector, limit, pretty, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1IngressClass patch_ingress_class(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1Ingress patch_namespaced_ingress(name, namespace, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1Ingress patch_namespaced_ingress_status(name, namespace, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1NetworkPolicy patch_namespaced_network_policy(name, namespace, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1IngressClass replace_ingress_class(name, body, pretty, dry_run, field_manager)
...
> crate::models::V1Ingress replace_namespaced_ingress(name, namespace, body, pretty, dry_run, field_manager)
...
> crate::models::V1Ingress replace_namespaced_ingress_status(name, namespace, body, pretty, dry_run, field_manager)
...
> crate::models::V1NetworkPolicy replace_namespaced_network_policy(name, namespace, body, pretty, dry_run, field_manager)
