...
> crate::models::V1alpha1CsiStorageCapacity create_namespaced_csi_storage_capacity(namespace, body, pretty, dry_run, field_manager)
...
**body** | [**V1alpha1CsiStorageCapacity**](V1alpha1CsiStorageCapacity.md) |  | [required] |
...
[**crate::models::V1alpha1CsiStorageCapacity**](v1alpha1.CSIStorageCapacity.md)
...
> crate::models::V1alpha1VolumeAttachment create_volume_attachment(body, pretty, dry_run, field_manager)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1alpha1VolumeAttachment**](V1alpha1VolumeAttachment.md) |  | [required] |
**pretty** | Option<**String**> | If 'true', then the output is pretty printed. |  |
**dry_run** | Option<**String**> | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed |  |
**field_manager** | Option<**String**> | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. |  |
...
[**crate::models::V1alpha1VolumeAttachment**](v1alpha1.VolumeAttachment.md)
...
> crate::models::V1alpha1VolumeAttachment delete_volume_attachment(name, pretty, dry_run, grace_period_seconds, orphan_dependents, propagation_policy, body)
...
> crate::models::V1alpha1CsiStorageCapacityList list_csi_storage_capacity_for_all_namespaces(allow_watch_bookmarks, _continue, field_selector, label_selector, limit, pretty, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1alpha1CsiStorageCapacityList**](v1alpha1.CSIStorageCapacityList.md)
...
> crate::models::V1alpha1CsiStorageCapacityList list_namespaced_csi_storage_capacity(namespace, pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1alpha1VolumeAttachmentList list_volume_attachment(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1alpha1VolumeAttachmentList**](v1alpha1.VolumeAttachmentList.md)
...
> crate::models::V1alpha1CsiStorageCapacity patch_namespaced_csi_storage_capacity(name, namespace, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1alpha1VolumeAttachment patch_volume_attachment(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1alpha1CsiStorageCapacity read_namespaced_csi_storage_capacity(name, namespace, pretty)
...
> crate::models::V1alpha1VolumeAttachment read_volume_attachment(name, pretty)
...
> crate::models::V1alpha1CsiStorageCapacity replace_namespaced_csi_storage_capacity(name, namespace, body, pretty, dry_run, field_manager)
...
> crate::models::V1alpha1VolumeAttachment replace_volume_attachment(name, body, pretty, dry_run, field_manager)
