...
> crate::models::V1alpha1RuntimeClass create_runtime_class(body, pretty, dry_run, field_manager)
...
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1alpha1RuntimeClass**](V1alpha1RuntimeClass.md) |  | [required] |
...
[**crate::models::V1alpha1RuntimeClass**](v1alpha1.RuntimeClass.md)
...
> crate::models::V1Status delete_collection_runtime_class(pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, timeout_seconds, body)
...
> crate::models::V1alpha1RuntimeClassList list_runtime_class(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1alpha1RuntimeClassList**](v1alpha1.RuntimeClassList.md)
...
> crate::models::V1alpha1RuntimeClass patch_runtime_class(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1alpha1RuntimeClass read_runtime_class(name, pretty)
...
> crate::models::V1alpha1RuntimeClass replace_runtime_class(name, body, pretty, dry_run, field_manager)
