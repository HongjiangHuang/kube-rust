...
> crate::models::V1alpha1StorageVersion create_storage_version(body, pretty, dry_run, field_manager)
...
> crate::models::V1Status delete_collection_storage_version(pretty, _continue, dry_run, field_selector, grace_period_seconds, label_selector, limit, orphan_dependents, propagation_policy, resource_version, resource_version_match, timeout_seconds, body)
...
> crate::models::V1alpha1StorageVersionList list_storage_version(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1alpha1StorageVersion patch_storage_version(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1alpha1StorageVersion patch_storage_version_status(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1alpha1StorageVersion replace_storage_version(name, body, pretty, dry_run, field_manager)
...
> crate::models::V1alpha1StorageVersion replace_storage_version_status(name, body, pretty, dry_run, field_manager)
