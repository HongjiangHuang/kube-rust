...
> crate::models::V1Lease create_namespaced_lease(namespace, body, pretty, dry_run, field_manager)
...
> crate::models::V1LeaseList list_lease_for_all_namespaces(allow_watch_bookmarks, _continue, field_selector, label_selector, limit, pretty, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1LeaseList list_namespaced_lease(namespace, pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
> crate::models::V1Lease patch_namespaced_lease(name, namespace, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1Lease replace_namespaced_lease(name, namespace, body, pretty, dry_run, field_manager)
