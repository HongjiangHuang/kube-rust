...
> crate::models::V1beta1MutatingWebhookConfiguration create_mutating_webhook_configuration(body, pretty, dry_run, field_manager)
...
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1beta1MutatingWebhookConfiguration**](V1beta1MutatingWebhookConfiguration.md) |  | [required] |
...
[**crate::models::V1beta1MutatingWebhookConfiguration**](v1beta1.MutatingWebhookConfiguration.md)
...
> crate::models::V1beta1ValidatingWebhookConfiguration create_validating_webhook_configuration(body, pretty, dry_run, field_manager)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**V1beta1ValidatingWebhookConfiguration**](V1beta1ValidatingWebhookConfiguration.md) |  | [required] |
**pretty** | Option<**String**> | If 'true', then the output is pretty printed. |  |
**dry_run** | Option<**String**> | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed |  |
**field_manager** | Option<**String**> | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. |  |
...
[**crate::models::V1beta1ValidatingWebhookConfiguration**](v1beta1.ValidatingWebhookConfiguration.md)
...
> crate::models::V1beta1MutatingWebhookConfigurationList list_mutating_webhook_configuration(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1beta1MutatingWebhookConfigurationList**](v1beta1.MutatingWebhookConfigurationList.md)
...
> crate::models::V1beta1ValidatingWebhookConfigurationList list_validating_webhook_configuration(pretty, allow_watch_bookmarks, _continue, field_selector, label_selector, limit, resource_version, resource_version_match, timeout_seconds, watch)
...
[**crate::models::V1beta1ValidatingWebhookConfigurationList**](v1beta1.ValidatingWebhookConfigurationList.md)
...
> crate::models::V1beta1MutatingWebhookConfiguration patch_mutating_webhook_configuration(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1beta1ValidatingWebhookConfiguration patch_validating_webhook_configuration(name, body, pretty, dry_run, field_manager, force)
...
> crate::models::V1beta1MutatingWebhookConfiguration read_mutating_webhook_configuration(name, pretty)
...
> crate::models::V1beta1ValidatingWebhookConfiguration read_validating_webhook_configuration(name, pretty)
...
> crate::models::V1beta1MutatingWebhookConfiguration replace_mutating_webhook_configuration(name, body, pretty, dry_run, field_manager)
...
> crate::models::V1beta1ValidatingWebhookConfiguration replace_validating_webhook_configuration(name, body, pretty, dry_run, field_manager)
